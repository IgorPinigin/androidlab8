...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        buttonUpdate = (Button) findViewById(R.id.buttonRef);
        buttonUpdate.setOnClickListener(this);

        buttonDelete = (Button) findViewById(R.id.buttonDel);
        buttonDelete.setOnClickListener(this);

        etID = (EditText) findViewById(R.id.TextEditID);
        etName = (EditText) findViewById(R.id.TextEditName);
        etEmail = (EditText) findViewById(R.id.TextEditEmail);
